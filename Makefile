...
#INCDIR          += -I$(TOPDIR)/niu/lib/cjson/inc
INCDIR		:= $(TOPDIR)/niu/include
#LIBDIR		:= $(TOPDIR)/libs
LIBDIR		:= $(TOPDIR)/niu/lib
DOCDIR		:= $(TOPDIR)/doc
...
export        TOPDIR INCDIR	LIBDIR OUTDIR OBJDIR BINDIR DOCDIR RESDIR
...
# 设定需要排除编译的目录
EXDIRS := out include libs doc resource CVS
...
$(TARGET):
	...
	@echo '编译完成，生成./out/bin/niu_app执行文件'
	chown 1000:1000 ./out/bin/niu_app
	chmod 777 ./out/bin/niu_app
	
	#mkdir -p ../mainApp/app/
	#cp ./out/bin/niu_app ../mainApp/app/
	#cp ./out/bin/fleety_app /home/wangyang/3520d/mainApp/app/
	#cp ./out/bin/fleety_app /home/zhengfeilong/new_project/570/mainApp/app/
	#@echo "INCDIRS = " $(INCDIR)
