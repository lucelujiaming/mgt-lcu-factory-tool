...
#LDFLAGS = -L$(LIBDIR) -ldebug -lfifo -lpthread -lcb -llist -lnmea #-ljpeg -lspeex -lsqlite3 -static
#LDFLAGS += -Wl,-rpath=/opt/hisi-linux-nptl/arm-hisiv100-linux/uClibc++/0.2.0/lib
#LDFLAGS += -lMdvrSdk -lgpsapp

LDFLAGS = -L$(LIBDIR) -lpthread -ldebug -lcurl -lrt
#LDFLAGS += -Wl
...
#ifeq ($(gb2014), y)
#CFLAGS += -D GB2014_PROTOCOL
#endif

#ifeq ($(szmeter2017), y)
#CFLAGS += -D SZMETER_2017
#endif

#ifeq ($(wyc), y)
#CFLAGS += -D SHENZHEN_WYC
#endif
...
#ifeq ($(thirdlibs),y)
#CFLAGS += -D JPEG_LIB_SUPPORT
#LDFLAGS += -ljpeg  

#CFLAGS += -D SQLITE3_LIB_SUPPORT
#LDFLAGS += -lsqlite3

#CFLAGS += -D SPEEX_LIB_SUPPORT
#LDFLAGS += -lspeex
#endif
...
#ifeq ($(cmockery),y)
#CFLAGS += -D UNIT_TESTING -I /usr/local/include/google
#LDFLAGS += -L /usr/local/lib -lcmockery
#endif
